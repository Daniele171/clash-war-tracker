...
export default function SettingsTab() {
  ...
  return (
    <>
      {isAdmin && (
        <>
          ...
          {(isMaster || perms?.adminCanCreateUser) && (
            <div className="bg-[#151525]/80 backdrop-blur-xl shadow-2xl border border-cr-gold/20 rounded-2xl p-6 shadow-xl border border-border-gold/20 mb-5">
          ...
          <div className="bg-[#151525]/80 backdrop-blur-xl shadow-2xl border border-cr-gold/20 rounded-2xl p-6 shadow-xl border border-border-gold/20 mb-6">
      ...
      <div className="bg-[#151525]/80 backdrop-blur-xl shadow-2xl border border-cr-gold/20 rounded-2xl p-6 shadow-xl border border-border-gold/20">
