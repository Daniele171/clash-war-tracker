...
function parseCRDate(dateStr: string): Date {
  ...
  try {
    ...
    if (m) {
      const d = new Date(`${m[1]}-${m[2]}-${m[3]}T${m[4]}:${m[5]}:${m[6]}.000Z`);
...
export default function HistoryTab() {
  ...
  return (
    <>
      {/* Current war notice */}
      {currentWar && (
        <div className="bg-[#151525]/80 backdrop-blur-xl shadow-2xl border border-cr-gold/20 rounded-2xl p-6 shadow-xl border border-border-gold/20 mb-4 border-[rgba(37,99,235,0.4)] bg-[rgba(37,99,235,0.07)]">
                        ...
                        <table className="w-full border-collapse min-w-[420px]">
                          <thead>
                            <tr>
                              ...
                              <th className="bg-[rgba(240,192,48,0.07)] text-[#8888a8] text-[10px] font-semibold uppercase tracking-wider px-3 py-2 text-left">🏅</th>
                              <th className="bg-[rgba(240,192,48,0.07)] text-[#8888a8] text-[10px] font-semibold uppercase tracking-wider px-3 py-2 text-left">Mazzi</th>
